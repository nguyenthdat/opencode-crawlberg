  ...
  return new Promise((resolve, reject) => {
    ...
    child.on("close", (exitCode, signal) => {
      ...
      resolve({
        ...
        metadata: { exitCode, signal, command: "crawlberg", subcommand: args[0] },
      });
    });
  });
}

function pushSharedOptions(cliArgs, args) {
  ...
  tool: {
    crawlberg_scrape: tool({
      ...
      async execute(args, context) {
        ...
        pushSharedOptions(cliArgs, args);
    ...
    crawlberg_map: tool({
      ...
      args: {
        ...
        format: outputFormat,
        timeout: sharedArgs.timeout,
        browser_mode: browserMode,
        browser_endpoint: sharedArgs.browser_endpoint,
        respect_robots_txt: sharedArgs.respect_robots_txt,
